            ...
            "
                    >
                        <div className="flex-1 space-y-1">
                            ...
                            <p className="text-xs-line text-brand-cream/75 leading-relaxed">
                        ...
                        <div className="flex md:flex-col gap-2 md:items-end">
                            <div className="px-3 py-1  border border-brand-gold/40 text-[9px] text-brand-gold/90 uppercase tracking-[0.18em]">
                                Full-time · Nusa Dua
                            </div>
                        </div>
                    </div>
                ...
                "
                    ...
                    >
                        ...
                        <p className="max-w-md mx-auto text-xs-line text-brand-cream/60 leading-relaxed">
