...
export default function ContactHero() {
  return (
    <section className="relative h-[360px] md:h-[420px] w-full overflow-hidden">
      ...
      >
        <Image
          src="/images/about.png" // ganti sesuai foto ambience restoran
          alt="Contact Jard’or Nusa Dua"
          fill
          priority
      ...
      <div className="relative z-10 flex h-full items-center">
        ...
        >
          ...
          >
            We’re here to assist with your inquiries, collaborations, or
            private dining requests — reach out, and we’ll curate your Jard’or
            experience.
          </motion.p>
