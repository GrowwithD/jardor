...
export default function ReservationHero() {
    return (
        <section className="relative h-[360px] md:h-[420px] w-full overflow-hidden">
            ...
            >
                <Image
                    src="/images/about.png" // ganti dengan image hero reservation
            ...
            <div className="relative z-10 flex h-full items-center">
                ...
                >
                    ...
                    >
                        A refined dining experience by reservation only —
                        share your details and our concierge will personally follow up
                        to arrange your evening at Jard&apos;or.
                    </motion.p>
